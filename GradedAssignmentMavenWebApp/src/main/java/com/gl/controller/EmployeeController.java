...
SessionFactory seFactory=new Configuration().configure().buildSessionFactory();
	...
	public String insertEmployee(@RequestParam String employeeName,@RequestParam String employeeAddress,@RequestParam String employeePhone,@RequestParam double employeeSalary,Model data)
	{
...
SessionFactory seFactory=new Configuration().configure().buildSessionFactory();
	...
	public String updatesaveemployee(@RequestParam int empId,@RequestParam String employeeName,@RequestParam String employeeAddress,@RequestParam String employeePhone,@RequestParam double employeeSalary,Model data)
	{
...
SessionFactory seFactory=new Configuration().configure().buildSessionFactory();
	...
	public String deleteemployee(@RequestParam int empid,Model data)
	{
SessionFactory seFactory=new Configuration().configure().buildSessionFactory();
